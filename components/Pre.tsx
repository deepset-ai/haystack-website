...
export const Pre = ({ children, className, ...props }: Props): JSX.Element => {
  ...
  return (
    <div className="relative group shadow-lg bg-dark-blue p-4 mb-4 overflow-x-auto rounded">
      <pre
        {...props}
        ref={preRef}
      ...
      >
        <div className="absolute flex items-center space-x-2 top-0 right-0 m-2">
          <span
            className={`${
              copied ? "flex" : "hidden"
            } fade-in text-xs text-green-dark-theme`}
          >
            Copied!
          </span>
          ...
          <button
            ...
            className={classNames(
              "transition bg-transparent border rounded-md p-2 focus:outline-none group-hover:flex fade-in",
              {
