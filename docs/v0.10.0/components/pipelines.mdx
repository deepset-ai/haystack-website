...
Last but not least, we added some ready-made pipelines that allow you to run standard patterns with very few lines of code. See the [ready-made pipelines page](/components/v0.10.0/ready-made-pipelines) and [pipelines API documentation](/reference/pipelines) to learn more about these.
