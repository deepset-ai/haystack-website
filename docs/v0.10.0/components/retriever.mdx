...
See [Optimization](/guides/v0.10.0/optimization) for suggestions on how to choose top-k values.
...
If you’d like to learn how to set up a DPR based system, have a look at the [tutorial](/tutorials/v0.10.0/dense-passage-retrieval)!
...
**Training DPR:** Haystack supports training of your own DPR model! Check out the [tutorial](/tutorials/v0.10.0/train-dpr) to see how this is done!
