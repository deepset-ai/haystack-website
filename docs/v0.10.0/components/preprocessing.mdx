...
Check out our [preprocessing tutorial](/tutorials/v0.10.0/train-dpr) if you'd like to start working with code examples already!
...
Please refer to [the API docs](/reference/v0.10.0/file-converters) to see which converter best suits you.
...
For suggestions on how best to split your documents, see [Optimization](/guides/v0.10.0/optimization)
