...
- [Document](/components/v1.0.0/primitives#document)
- [Answer](/components/v1.0.0/primitives#answer)
- [Label](/components/v1.0.0/primitives#label)
- [MultiLabel](/components/v1.0.0/primitives#multilabel)
- [Span](/components/v1.0.0/primitives#span)
...
**Tip:** To see examples of these primitive classes being returned, have a look at [Ready-Made Pipelines](/components/v1.0.0/ready-made-pipelines).
...
Now we strongly recommend using our dedicated [`Document`](/components/v1.0.0/primitives) class as  a replacement.
The `text` field has been renamed `content` to accommodate for cases where it is used for another data format,
for example in [Table QA](/guides/v1.0.0/table-qa).
...
All Reader Nodes now return [Answer](/components/v1.0.0/primitives#label) objects instead of dictionaries.
...
To see their current structure see [Label](/components/v1.0.0/primitives#label).
