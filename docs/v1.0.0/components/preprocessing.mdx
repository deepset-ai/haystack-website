...
Check out our [preprocessing tutorial](/tutorials/v1.0.0/train-dpr) if you'd like to start working with code examples already!
...
To learn more about the `Document` class see [Primitives](/components/v1.0.0/primitives).
...
Please refer to [the API docs](/reference/v1.0.0/file-converters) to see which converter best suits you.
...
Converters are Haystack [Nodes](/components/v1.0.0/nodes) and can be added to [Pipelines](/components/v1.0.0/pipelines).
See our [Advanced Indexing Pipeline Tutorial](/tutorials/v1.0.0/doc-class-index) for an example.
...
For suggestions on how best to split your documents, see [Optimization](/guides/v1.0.0/optimization)
...
PreProcessors are Haystack [Nodes](/components/v1.0.0/nodes) and can be added to [Pipelines](/components/v1.0.0/pipelines).
See our [Advanced Indexing Pipeline Tutorial](/tutorials/v1.0.0/doc-class-index) for an example.
