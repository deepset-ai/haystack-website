...
The example Haystack pipeline that we’ll be using below is defined in the [pipelines.haystack-pipeline.yml](https://github.com/deepset-ai/haystack/blob/main/rest_api/rest_api/pipeline/pipelines.haystack-pipeline.yml) file.
