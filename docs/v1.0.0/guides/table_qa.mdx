...
If you have your tables embedded in raw files (e.g. within a PDF), you can use the `AzureConverter` to parse them into the required format (see [File Conversion](/preprocessing#file-conversion)). 
