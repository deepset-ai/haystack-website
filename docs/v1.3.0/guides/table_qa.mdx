...
**Tutorial:** Checkout our [Table QA tutorial](/tutorials/v1.3.0/table-qa) for a hands on guide on how to build your own system.
...
If you have your tables embedded in raw files (e.g. within a PDF), you can use the `AzureConverter` to parse them into the required format (see [File Conversion](/components/v1.3.0/preprocessing#file-conversion)). 
...
**Note:** When the [Answers](/components/v1.3.0/primitives#answers) are returned by the `TableReader`,
