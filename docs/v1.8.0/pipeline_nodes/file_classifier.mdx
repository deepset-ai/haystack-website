...
A File Classifier distinguishes between text, PDF, Markdown, Docx and HTML files and routes them to the appropriate [File Converter](/pipeline_nodes/v1.8.0/file-converters) in an indexing pipeline.
...
which then converts them into [Documents](/components/v1.8.0/documents-answers-labels#document).
