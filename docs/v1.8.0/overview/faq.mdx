...
your documents into smaller chunks by using the `PreProcessor` (see [tutorial](/tutorials/v1.8.0/pipelines)).

For more optimization suggestions, have a look at our [optimization page](/guides/v1.8.0/optimization)
...
See our [languages page](/guides/v1.8.0/languages) for more details.

<div style={{ marginBottom: "3rem" }} />

## How can I add metadata to my documents so that I can apply filters?

When providing your documents in the input format (see [here](/components/v1.8.0/document-store#input-format))
...
(for an example of what a `filters` dictionary might look like, please refer to [this example](/reference/v1.8.0/retriever#__init__))

<div style={{ marginBottom: "3rem" }} />

## How can I see each component's output if it's running in a pipeline?

To find out more about how to debug a pipeline, have a look at our [Pipelines documentation page](/components/v1.8.0/pipelines#returning-debugging-information).
...
For more information on model confidence and how to tune it, please refer to [this section](/pipeline_nodes/v1.8.0/reader#confidence-scores).
...
See [this section](/pipeline_nodes/v1.8.0/reader#deeper-dive-farm-vs-transformers)
