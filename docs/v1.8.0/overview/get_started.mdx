      ...
      content: (
        <div>
          <p>
              ...
              See <a href="https://haystack.deepset.ai/overview/v1.8.0/installation">Installation</a> for more details.
          </p>
          <pre>
      ...
      content: (
        <div>
          <p>
            ...
            See <a href="https://haystack.deepset.ai/overview/v1.8.0/quick-demo#local">Quick Demo</a> for more details.
          </p>
          <pre>
            <code>git clone https://github.com/deepset-ai/haystack.git</code>
            <code>cd haystack</code>
...
For a full guide on how to install Haystack see [Installation](/overview/v1.8.0/installation).
...
See [Quick Demo](/overview/v1.8.0/quick-demo) for details.
...
For a working code example, check out our [starter tutorial](/tutorials/v1.8.0/first-qa-system).
...
<div className="max-w-xl bg-yellow-light-theme border-l-8 border-yellow-dark-theme p-6 my-4 rounded-md dark:bg-yellow-900">
  ...
  See <a href="https://haystack.deepset.ai/guides/v1.8.0/optimization">Optimization</a> for more details.
...
Have a look at our [Pipelines page](/components/v1.8.0/pipelines) to see what's possible!
