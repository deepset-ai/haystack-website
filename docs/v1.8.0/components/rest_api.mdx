...
Existing API endpoints are defined using FastAPI route methods, e.g., in the [rest_api/rest_api/controller/search.py file](https://github.com/deepset-ai/haystack/blob/master/rest_api/controller/search.py#L52).
