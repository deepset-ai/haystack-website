...
**Tutorial:** Checkout our tutorial notebooks for a guide on how to build your own generative QA system with RAG ([here](/tutorials/v1.2.0/retrieval-augmented-generation))
or with LFQA ([here](/tutorials/v1.2.0/lfqa)).
