    ...
    options={[
        {
            ...
            content: (
                <div>
                <a href="https://www.elastic.co/guide/en/elasticsearch/reference/v1.2.0/current/install-elasticsearch.html">Install</a>&nbsp;
                Elasticsearch and then <a href="https://www.elastic.co/guide/en/elasticsearch/reference/v1.2.0/current/starting-elasticsearch.html">start</a>&nbsp;
