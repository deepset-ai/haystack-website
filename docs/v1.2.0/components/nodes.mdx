...
Nodes are chained together using a [Pipeline](/components/v1.2.0/pipelines).
...
For more information on this, see the [Pipelines](/components/v1.2.0/pipelines) page.
...
To find a ready-made example of a decision node, have a look at [the page](/components/v1.2.0/query-classifier) about the `QueryClassifier`.
...
- [EvalDocuments](/reference/v1.2.0/evaluation#evaldocuments)
- [EvalAnswers](/reference/v1.2.0/evaluation#evalanswers)

To get hands on with this kind of node, have a look at the [evaluation tutorial](/tutorials/v1.2.0/evaluation).
