...
If you want to find out which class methods are called by a component's `run()` function, we recommend that you take a look at the definitions (e.g. the [Retriever source code](https://github.com/deepset-ai/haystack/blob/main/haystack/nodes/retriever/base.py#L210)).
