...
Metadata can be attached to the documents which you index into your DocumentStore (see the input data format [here](/usage/v0.9.0/retriever)).
...
(see our the Arguments on the [Pipelines page](/usage/v0.9.0/pipelines) for an explanation).
