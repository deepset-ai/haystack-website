...
See [our tutorial](/tutorials/v0.9.0/train-dpr) and also the [API reference](/reference/v0.9.0/retriever#train) for `DensePassageRetriever.train()` for more details.
