...
For another example YAML config, check out [this file](https://github.com/deepset-ai/haystack/blob/v0.9.0/rest_api/pipeline/pipelines.yaml).
...
To get hands on with this kind of node, have a look at the [evaluation tutorial](/tutorials/v0.9.0/evaluation).
...
See also the [Pipelines API documentation](/reference/v0.9.0/pipelines) for more details.
