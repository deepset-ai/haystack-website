...
See [our tutorial](/tutorials/v1.5.0/train-dpr) and also the [API reference](/reference/v1.5.0/retriever#train) for `DensePassageRetriever.train()` for more details.
