...
To learn more about these pipelines, have a look at our [ready-made pipelines page](/components/v1.5.0/ready-made-pipelines).
To start using the pipelines, check out the [question generation tutorial](/tutorials/v1.5.0/question-generation).
