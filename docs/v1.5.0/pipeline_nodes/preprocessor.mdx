...
For suggestions on how best to split your documents, see [Optimization](/guides/v1.5.0/optimization).
...
**Tutorial:** To start working with code examples, have a look at the [preprocessing tutorial](/tutorials/preprocessing). For ideas on what you can do at indexing time, see
    [advanced indexing tutorial](/tutorials/v1.5.0/doc-class-index).
...
To learn more about the `Document` class, see [Documents, Answers, and Labels](/components/v1.5.0/documents-answers-labels).
