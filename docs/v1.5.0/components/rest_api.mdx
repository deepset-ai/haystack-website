...
The example Haystack pipeline that we’ll be using below is defined in the [rest_api/rest_api/pipeline/pipelines.haystack-pipeline.yml](https://github.com/deepset-ai/haystack/blob/main/rest_api/rest_api/pipeline/pipelines.haystack-pipeline.yml) file.
...
See the definitions of the different endpoints available on the latest main version [here](/components/v1.5.0/rest-api-definition).
