...
Note that the Retriever functions as a [Node](/pipeline_nodes/v1.5.0/overview)
...
See [PreProcessor}](/pipeline_nodes/v1.5.0/preprocessor) for more information on the cleaning and splitting steps that will help you maximize Haystack's performance.
