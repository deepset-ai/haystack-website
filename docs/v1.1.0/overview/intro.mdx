...
please check out [Get Started](/v1.1.0/overview/get-started).
...
- **NLP for Search**: Pick components that perform [retrieval](/v1.1.0/components/retriever),
[question answering](/v1.1.0/components/reader), [reranking](/v1.1.0/components/ranker) and much more
...
- **Flexible databases**: Load data into and query from a range of [databases](/v1.1.0/components/document-store) such as Elasticsearch, Milvus, FAISS, SQL and more

- **Scalability**: [Scale your system](/v1.1.0/guides/optimization) to handle millions of documents and deploy them via [REST API](/v1.1.0/guides/rest-api)

- **Domain adaptation**: All tooling you need to [annotate](/v1.1.0/guides/annotation) examples, collect [user-feedback](/v1.1.0/guides/domain-adaptation#user-feedback), [evaluate](/v1.1.0/guides/evaluation) components and [finetune](/v1.1.0/guides/domain-adaptation) models.
...
- [Question Answering](/v1.1.0/components/ready-made-pipelines#extractiveqapipeline)
- [Summarization](/v1.1.0/components/ready-made-pipelines#searchsummarizationpipeline)
- [Document Search](/v1.1.0/components/ready-made-pipelines#documentsearchpipeline)
- [Question Generation](/v1.1.0/components/ready-made-pipelines#questiongenerationpipeline)
...
Haystack offers different [Nodes](/v1.1.0/components/nodes) that perform different kinds of text processing.
...
The [Pipeline](/v1.1.0/components/pipelines) is the key to making this modular approach work.
...
On top of simplifying data flow logic, this also allows for complex routing options such as those involving [decision nodes](/v1.1.0/components/nodes#decision-nodes).
...
For this, Haystack comes with a [REST API](/v1.1.0/guides/rest-api) that is designed to work in production environments.

When set up like this, you can load [Pipelines from YAML files](/v1.1.0/components/pipelines#yaml-file-definitions),
...
harnesses the reading comprehension power of the [Reader](/v1.1.0/components/reader)
but also applies it to large document bases with the help of the [Retriever](/v1.1.0/components/retriever).
...
** Question Answering Tutorial**: To start building your first question answering system, see our [Introductory Tutorial](/v1.1.0/tutorials/first-qa-system)
...
Many of the synergistic Node combinations are covered by our [Ready Made Pipelines](/v1.1.0/components/ready-made-pipelines)
