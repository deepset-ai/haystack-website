...
- [Document](/v1.1.0/components/primitives#document)
- [Answer](/v1.1.0/components/primitives#answer)
- [Label](/v1.1.0/components/primitives#label)
- [MultiLabel](/v1.1.0/components/primitives#multilabel)
- [Span](/v1.1.0/components/primitives#span)
...
**Tip:** To see examples of these primitive classes being returned, have a look at [Ready-Made Pipelines](/v1.1.0/components/ready-made-pipelines).
...
Now we strongly recommend using our dedicated [`Document`](/v1.1.0/components/primitives) class as  a replacement.
The `text` field has been renamed `content` to accommodate for cases where it is used for another data format,
for example in [Table QA](/v1.1.0/guides/table-qa).
...
All Reader Nodes now return [Answer](/v1.1.0/components/primitives#label) objects instead of dictionaries.
...
To see their current structure see [Label](/v1.1.0/components/primitives#label).
