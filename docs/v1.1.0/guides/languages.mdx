...
See [our tutorial](/v1.1.0/tutorials/train-dpr) and also the [API reference](/v1.1.0/reference/retriever#train) for `DensePassageRetriever.train()` for more details.
