...
To get started using Haystack for evaluation, we recommend having a look at our [evaluation tutorial](/v1.1.0/tutorials/evaluation)
...
You can already start trying out SAS in our [Evaluation Tutorial](/v1.1.0/tutorials/evaluation). You can read more about SAS in [this paper](https://arxiv.org/abs/2108.06130).
...
Please check out our [annotation tool](/v1.1.0/guides/annotation) if you're interested in creating your own dataset.
