...
**Tutorial:** Checkout our [Table QA tutorial](/v1.1.0/tutorials/table-qa) for a hands on guide on how to build your own system.
...
If you have your tables embedded in raw files (e.g. within a PDF), you can use the `AzureConverter` to parse them into the required format (see [File Conversion](/v1.1.0/components/preprocessing#file-conversion)).
...
**Note:** When the [Answers](/v1.1.0/components/primitives#answers) are returned by the `TableReader`,
