...
take a look at our [Model Distillation guide](/model-distillation).
...
Metadata can be attached to the documents which you index into your DocumentStore (see the input data format [here](/v1.1.0/components/retriever)).
...
(see our the Arguments on the [Pipelines page](/v1.1.0/components/pipelines) for an explanation).
