...
Check out our [preprocessing tutorial](/v1.1.0/tutorials/preprocessing) if you'd like to start working with code examples already!
...
To learn more about the `Document` class see [Primitives](/v1.1.0/components/primitives).
...
Please refer to [the API docs](/v1.1.0/reference/file-converters) to see which converter best suits you.
...
Converters are Haystack [Nodes](/v1.1.0/components/nodes) and can be added to [Pipelines](/v1.1.0/components/pipelines).
See our [Advanced Indexing Pipeline Tutorial](/v1.1.0/tutorials/doc-class-index) for an example.
...
For suggestions on how best to split your documents, see [Optimization](/v1.1.0/guides/optimization)
...
PreProcessors are Haystack [Nodes](/v1.1.0/components/nodes) and can be added to [Pipelines](/v1.1.0/components/pipelines).
See our [Advanced Indexing Pipeline Tutorial](/v1.1.0/tutorials/doc-class-index) for an example.
