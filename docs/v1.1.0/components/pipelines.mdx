...
To learn about how to call a single Node outside of a Pipeline, see the [Nodes Usage](/components/v1.1.0/nodes#usage) page.
...
The `components` section is used to define the initialization of your [Nodes](/components/v1.1.0/nodes).
...
Last but not least, we added some ready-made pipelines that allow you to run standard patterns with very few lines of code. See the [ready-made pipelines page](/components/v1.1.0/ready-made-pipelines) and [pipelines API documentation](/reference/v1.1.0/pipelines) to learn more about these.
