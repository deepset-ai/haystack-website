...
To learn about how to call a single Node outside of a Pipeline, see the [Nodes Usage](/v1.1.0/components/nodes#usage) page.
...
The `components` section is used to define the initialization of your [Nodes](/v1.1.0/components/nodes).
...
Last but not least, we added some ready-made pipelines that allow you to run standard patterns with very few lines of code. See the [ready-made pipelines page](/v1.1.0/components/ready-made-pipelines) and [pipelines API documentation](/v1.1.0/reference/pipelines) to learn more about these.
