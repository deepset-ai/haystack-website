...
To learn more about how to use this component in Haystack, have a look at our [Table Question Answering](/v1.1.0/guides/table-qa) guide.
...
See [Optimization](/v1.1.0/guides/optimization) for suggestions on how to choose top-k values.
...
If you’d like to learn how to set up a DPR based system, have a look at the [tutorial](/v1.1.0/tutorials/dense-passage-retrieval)!
...
**Training DPR:** Haystack supports training of your own DPR model! Check out the [tutorial](/v1.1.0/tutorials/train-dpr) to see how this is done!
