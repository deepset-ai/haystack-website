...
Have a look at our guide on [Table Question Answering](/v1.1.0/guides/table-qa) to find out more.
...
**Tutorial:** If you'd like a hands on example, check out our tutorial on fine-tuning [here](/v1.1.0/tutorials/fine-tuning-a-model)
