...
Nodes are chained together using a [Pipeline](/v1.1.0/components/pipelines).
...
For more information on this, see the [Pipelines](/v1.1.0/components/pipelines) page.
...
To find a ready-made example of a decision node, have a look at [the page](/v1.1.0/components/query-classifier) about the `QueryClassifier`.
...
- [EvalDocuments](/v1.1.0/reference/evaluation#evaldocuments)
- [EvalAnswers](/v1.1.0/reference/evaluation#evalanswers)

To get hands on with this kind of node, have a look at the [evaluation tutorial](/v1.1.0/tutorials/evaluation).
