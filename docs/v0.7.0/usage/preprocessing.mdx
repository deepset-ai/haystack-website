...
Please refer to [the API docs](/docs/file_convertersmd) to see which converter best suits you.
...
For suggestions on how best to split your documents, see [Optimization](/docs/optimizationmd)
