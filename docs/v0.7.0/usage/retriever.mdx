...
See [Optimization](/docs/optimizationmd) for suggestions on how to choose top-k values.
...
**Tip:** The Finder class is being deprecated and has been replaced by a more powerful [Pipelines class](/docs/pipelinesmd).
...
If you’d like to learn how to set up a DPR based system, have a look at the [tutorial](/docs/tutorial6md)!
...
**Training DPR:** Haystack supports training of your own DPR model! Check out the [tutorial](/docs/tutorial9md) to see how this is done!
