...
For more information, see the [Pipelines](/components/pipelines) page.
...
To find a ready-made example of a decision node, have a look at [QueryClassifier](/pipeline_nodes/query-classifier).
