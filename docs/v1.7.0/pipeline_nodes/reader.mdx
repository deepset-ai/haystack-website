...
|__Output__      | [Answers](/components/v1.7.0/documents-answers-labels#answer)                                                                                                             |
...
To find out more, have a look at our guide on [Table Question Answering](/guides/v1.7.0/table-qa).
...
Models trained on different data may be more suited to certain domains. For more information about models, see [Language Models](/guides/v1.7.0/language_models).
...
If you're using a sequence to sequence model such as BART, use the [Answer Generator](/pipeline_nodes/v1.7.0/answer-generator) instead.
...
**Tutorial:** For a hands-on example, check out our [tutorial on fine-tuning](/tutorials/v1.7.0/fine-tuning-a-model).
