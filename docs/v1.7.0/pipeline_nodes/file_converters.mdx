...
|||
|-------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|__Position in a Pipeline__| Either at the very beginning of an indexing Pipeline or after a [File Classifier](/pipeline_nodes/v1.7.0/file_classifier)|
|__Input__       | File name                                                                                                                                                                  |
...
**Tutorial:** To see an example of file converters in a pipeline, see the [advanced indexing tutorial](/tutorials/v1.7.0/doc-class-index).
