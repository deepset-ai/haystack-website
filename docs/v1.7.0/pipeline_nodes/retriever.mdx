...
See [Optimization](/guides/v1.7.0/optimization) for suggestions on how to choose top-k values.
...
To learn more about how to use this component in Haystack, have a look at our [Table Question Answering](/guides/v1.7.0/table-qa) guide.
...
BM25 is a variant of [TF-IDF](https://haystack.deepset.ai/pipeline_nodes/v1.7.0/retriever#tf-idf).
...
To use a private model hosted on Hugging Face, enter your Hugging Face access token in the `use_auth_token` parameter. For more information about models, see [Language Models](/guides/v1.7.0/language_models).
...
To learn how to set up a DPR-based system, have a look at the [Dense Passage Retrieval tutorial](/tutorials/v1.7.0/dense-passage-retrieval). 
...
**Training DPR:** Haystack supports training of your own DPR model! Check out the [tutorial](/tutorials/v1.7.0/train-dpr) to see how this is done!
