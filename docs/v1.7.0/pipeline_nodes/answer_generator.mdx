...
it can be used in isolation or as part of a [Pipeline](/components/v1.7.0/pipelines).
...
**Tutorial:** Build your own generative QA system with [RAG](/tutorials/v1.7.0/retrieval-augmented-generation)
and [LFQA](/tutorials/v1.7.0/lfqa).
