...
To use the QueryClassifier within a pipeline as a [decision node](/pipeline_nodes/v1.7.0/overview#decision-nodes), run:
...
You can see a code example of this configuration in [Usage](/pipeline_nodes/v1.7.0/query-classifier#usage).
