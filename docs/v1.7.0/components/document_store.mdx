...
Note that the Retriever functions as a [Node](/pipeline_nodes/v1.7.0/overview)
    ...
    options={[
        {
            ...
            content: (
                <div>
                <a href="https://www.elastic.co/guide/en/elasticsearch/reference/v1.7.0/current/install-elasticsearch.html">Install</a>&nbsp;
                Elasticsearch and then <a href="https://www.elastic.co/guide/en/elasticsearch/reference/v1.7.0/current/starting-elasticsearch.html">start</a>&nbsp;
...
See [PreProcessor}](/pipeline_nodes/v1.7.0/preprocessor) for more information on the cleaning and splitting steps that will help you maximize Haystack's performance.
