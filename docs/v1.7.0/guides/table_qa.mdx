...
**Tutorial:** Checkout our [Table QA tutorial](/tutorials/v1.7.0/table-qa) for a hands on guide on how to build your own system.
...
If you have your tables embedded in raw files (e.g. within a PDF), you can use the `AzureConverter` to parse them into the required format (see [File Converters](/pipeline_nodes/v1.7.0/file-converters)).
...
**Note:** When the [Answers](/components/v1.7.0/documents-answers-labels#answers) are returned by the `TableReader`,
