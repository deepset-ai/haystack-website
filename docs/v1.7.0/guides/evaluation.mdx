...
To get started using Haystack for evaluation, have a look at our [evaluation tutorial](/tutorials/v1.7.0/evaluation).
...
For more information, see the [Evaluation Tutorial](/tutorials/v1.7.0/evaluation).
...
You can already start trying out SAS in our [Evaluation Tutorial](/tutorials/v1.7.0/evaluation). You can read more about SAS in [Semantic Answer Similarity for Evaluating Question-Answering Models](https://arxiv.org/abs/2108.06130).
...
If you want to create your own dataset, have a look at [Annotation Tool](/components/v1.7.0/annotation). 
