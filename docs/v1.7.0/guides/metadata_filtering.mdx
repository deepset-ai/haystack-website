...
Metadata can be attached to the documents which you index into your DocumentStore (see the input data format [here](/pipeline_nodes/v1.7.0/retriever)).
...
(see our the Arguments on the [Pipelines page](/components/v1.7.0/pipelines) for an explanation).
