...
Thus, don't expect our [exemplary tutorial](/tutorials/v1.7.0/knowledge-graph) to work on your custom dataset out-of-the-box.
...
We provide an exemplary pre-trained model in our [tutorial](/tutorials/v1.7.0/knowledge-graph).
