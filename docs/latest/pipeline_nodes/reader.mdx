...
The Reader, is also known as an Open-Domain QA systems in Machine Learning speak.
...
|__Input__       | Documents                                                                                                                                                                  |
|__Output__      | Answers                                                                                                             |
|__Classes__     | FARMReader, TransformersReader                                                                                                          |
|||
...
Here are our recommendations for models to start with:
