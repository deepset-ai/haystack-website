    ...
    options={[
        {
            ...
            content: (
                <div>
                    ...
                    <br></br>
                    To found out more about how it was trained and how well it performed, see its <a href="https://huggingface.co/shahrukhx01/bert-mini-finetune-question-detection">model card</a>.
                </div>
            )
        },
        {
            ...
            content: (
                <div>
                    ...
                    <br></br>
                    To found out more about how it was trained and how well it performed, see its <a href="https://huggingface.co/shahrukhx01/question-vs-statement-classifier">model card</a>.
                </div>
            )
        },
        {
            ...
            content: (
                <div>
                    ...
                    Output 2: Keyword<br></br>
                    <br></br>
                    To found out more about how it was trained and how well it performed, see its <a href="https://ext-models-haystack.s3.eu-central-1.amazonaws.com/gradboost_query_classifier/readme.txt">Readme</a>.
                </div>
            )
        },
        {
            ...
            content: (
                <div>
                    ...
                    Output 2: Statement<br></br>
                    <br></br>
                    To found out more about how it was trained and how well it performed, see its <a href="https://ext-models-haystack.s3.eu-central-1.amazonaws.com/gradboost_query_classifier_statements/readme.txt">Readme</a>.
                </div>
            )
        },
    ]}
