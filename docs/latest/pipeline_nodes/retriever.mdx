...
|           | Memory | Elasticsearch | OpenSearch | OpenDistroElasticsearch | SQL | FAISS | Milvus | Weaviate | Pinecone |
| --------- | ------ | ------------- | ---------- | ----------------------- | --- | ----- | ------ | -------- | -------- |
| BM25      | N      | Y             | Y          | Y                       | N   | N     | N      | N        | N        |      
| TF-IDF    | Y      | Y             | Y          | Y                       | Y   | N     | N      | Y        | Y        |
| Embedding | Y      | Y             | Y          | Y                       | N   | Y     | Y      | Y        | Y        |
| DPR       | Y      | Y             | Y          | Y                       | N   | Y     | Y      | Y        | Y        |
