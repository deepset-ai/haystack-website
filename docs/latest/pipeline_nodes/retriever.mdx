...
These models are trained in Siamese Networks and use triplet loss such that they learn to embed similar sentences near to each other in a shared embedding space. For more information about models, see [Language Models](/guides/language_models).
...
To learn how to set up a DPR-based system, have a look at the [Dense Passage Retrieval tutorial](/tutorials/dense-passage-retrieval). For more information about models, see [Language Models](/guides/language_models).
