...
Haystack's Summmarizer is here to help you make sense of the documents at a glance. This Component is a good
way to get a short overview of a Document that is otherwise quite long.
Using the Summarizer, you could, for example, gain a glimpse into what Documents your Retriever is returning.
