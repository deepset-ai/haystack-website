...
For a list of compatible models, see the HuggingFace [Model Hub](https://huggingface.co/models?pipeline_tag=translation&sort=downloads).
...
## Use Case: Wrapping another Pipeline
