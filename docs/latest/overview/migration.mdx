...
All Reader Nodes now return [Answer](/components/primitives#label) objects instead of dictionaries.
...
To see their current structure see [Label](/components/primitives#label).
