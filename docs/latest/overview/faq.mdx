...
For more optimization suggestions, have a look at our [optimization page](https://haystack.deepset.ai/guides/optimization)
...
See our [languages page](https://haystack.deepset.ai/guides/languages) for more details.
...
For more information on model confidence and how to tune it, please refer to [this section](https://haystack.deepset.ai/pipeline_nodes/reader#confidence-scores).
...
See [this section](https://haystack.deepset.ai/pipeline_nodes/reader#deeper-dive-farm-vs-transformers)
