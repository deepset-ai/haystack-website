...
your documents into smaller chunks by using the `PreProcessor` (see [tutorial](/tutorials/pipelines)).

For more optimization suggestions, have a look at our [optimization page](/guides/optimization)
...
See our [languages page](/guides/languages) for more details.

<div style={{ marginBottom: "3rem" }} />

## How can I add metadata to my documents so that I can apply filters?

When providing your documents in the input format (see [here](/components/document-store#input-format))
...
(for an example of what a `filters` dictionary might look like, please refer to [this example](/reference/retriever#__init__))

<div style={{ marginBottom: "3rem" }} />

## How can I see each component's output if it's running in a pipeline?

To find out more about how to debug a pipeline, have a look at our [Pipelines documentation page](/components/pipelines#returning-debugging-information).
...
For more information on model confidence and how to tune it, please refer to [this section](/pipeline_nodes/reader#confidence-scores).
...
See [this section](/pipeline_nodes/reader#deeper-dive-farm-vs-transformers)
