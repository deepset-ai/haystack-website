...
|||
|-------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Description | The generator reads a set of documents and generates an answer to a question, word by word. It is placed after the Retriever and can be used as a substitute to the Reader.  |
| Input       | Documents                                                                                                                                                                   |
| Output      | Answers                                                                                                                                                                     |
