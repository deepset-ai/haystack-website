...
The first Node in an indexing pipeline will usually be a [File Convertor](/pipeline_nodes/file_converters) or a FileTypeClassifier and take "File" as its input.
