...
For another example YAML configuration, check out [Pipelines in GitHub](https://github.com/deepset-ai/haystack/tree/main/rest_api/pipeline).
...
and [in our repo](https://raw.githubusercontent.com/deepset-ai/haystack/main/haystack/json-schemas/haystack-pipeline.schema.json).
