...
In all of our nodes, you can enable debugging in two ways.
...
To return debug data from a Node, add a `_debug` key in the output dict. The value can be a primitive or a dict.
For instance,
