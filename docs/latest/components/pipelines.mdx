...
For another example YAML configuration, check out [the pipelines.yaml file](https://github.com/deepset-ai/haystack/blob/master/rest_api/pipeline/pipelines.yaml).
