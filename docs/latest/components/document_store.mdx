...
<Disclosures
    options={[
        ...
        },
        {
            ...
            content: (
                <div>
                To initialize the Pinecone document store, provide an API key and Pinecone cloud environment. To obtain the API key, <a href="https://app.pinecone.io">create a free Pinecone account</a>. The enviroment is <code>us-west1-gcp</code> by default. 
