...
way to get a glance at a Document that is otherwise quite long. Imagine all the Documents a Retriever returns, 
you could for example use the Summarizer to have a quick look at what each of them contain.
