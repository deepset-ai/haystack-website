...
| Student model            | Teacher model                                        | Distilled model EM | Baseline EM | Teacher EM | Link                                                                      |
| ------------------------ | ---------------------------------------------------- | ------------------ | ----------- | ---------- | ------------------------------------------------------------------------- |
| prajjwal1/bert-medium    | deepset/bert-large-uncased-whole-word-masking-squad2 | 68.6%              | 65.6%       | 78.9%      | [here](https://huggingface.co/deepset/bert-medium-squad2-distilled)       |
| roberta-base             | deepset/roberta-large-squad2                         | 79.8%              | 78.3%       | 83.6%      | [here](https://huggingface.co/deepset/roberta-base-squad2-distilled)      |
| deepset/xlm-roberta-base | deepset/xlm-roberta-large-squad2                     | 74.8%              | 73.8%       | 80.0%      | [here](https://huggingface.co/deepset/xlm-roberta-base-squad2-distilled)  |
| deepset/gelectra-base    | deepset/gelectra-large-germanquad                    | 61.8%              | 59.4%       | 68.0%      | [here](https://huggingface.co/deepset/gelectra-base-germanquad-distilled) |

| Student model            | Teacher model                                        | Distilled model F1 | Baseline F1 | Teacher F1 | Link                                                                      |
| ------------------------ | ---------------------------------------------------- | ------------------ | ----------- | ---------- | ------------------------------------------------------------------------- |
| prajjwal1/bert-medium    | deepset/bert-large-uncased-whole-word-masking-squad2 | 72.8%              | 69.6%       | 83.2%      | [here](https://huggingface.co/deepset/bert-medium-squad2-distilled)       |
| roberta-base             | deepset/roberta-large-squad2                         | 83.9%              | 82.6%       | 87.9%      | [here](https://huggingface.co/deepset/roberta-base-squad2-distilled)      |
| deepset/xlm-roberta-base | deepset/xlm-roberta-large-squad2                     | 79.0%              | 78%         | 84.4%      | [here](https://huggingface.co/deepset/xlm-roberta-base-squad2-distilled)  |
| deepset/gelectra-base    | deepset/gelectra-large-germanquad                    | 80.4%              | 77.2%       | 86.4%      | [here](https://huggingface.co/deepset/gelectra-base-germanquad-distilled) |
