...
| Student model            | Teacher model                                        | Distilled model EM | Distilled model F1 | Baseline EM | Baseline F1 | Teacher EM | Teacher F1 | Link                                                                      |
| ------------------------ | ---------------------------------------------------- | ------------------ | ------------------ | ----------- | ----------- | ---------- | ---------- | ------------------------------------------------------------------------- |
| prajjwal1/bert-medium    | deepset/bert-large-uncased-whole-word-masking-squad2 | 68.6%              | 72.8%              | 65.6%       | 69.6%       | 78.9%      | 83.2%      | [here](https://huggingface.co/deepset/bert-medium-squad2-distilled)       |
| roberta-base             | deepset/roberta-large-squad2                         | 79.8%              | 83.9%              | 78.3%       | 82.6%       | 83.6%      | 87.9%      | [here](https://huggingface.co/deepset/roberta-base-squad2-distilled)      |
| deepset/xlm-roberta-base | deepset/xlm-roberta-large-squad2                     | 74.8%              | 79.0%              | 73.8%       | 78%         | 80.0%      | 84.4%      | [here](https://huggingface.co/deepset/xlm-roberta-base-squad2-distilled)  |
| deepset/gelectra-base    | deepset/gelectra-large-germanquad                    | 61.8%              | 80.4%              | 59.4%       | 77.2%       | 68.0%      | 86.4%      | [here](https://huggingface.co/deepset/gelectra-base-germanquad-distilled) |
