...
You don't need to have in-depth knowledge of the architecture to be able to use a model but it's usually best to start with the models using the newest architecture. So it may be useful for you to know which architectures were developed chronologically:
