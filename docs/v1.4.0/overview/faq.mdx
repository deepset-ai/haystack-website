...
See our [languages page](https://haystack.deepset.ai/usage/v1.4.0/languages) for more details.
...
See [this section](https://haystack.deepset.ai/usage/v1.4.0/reader#deeper-dive-farm-vs-transformers)
