...
When used in combination with a Reader, it is a tool for quickly sifting out irrelevant documents,
...
and pass on the best candidates.
...
If you can't use GPU, we recommend the BM25 retriever.
...
To learn more about how to use this component in Haystack, have a look at our [Table Question Answering](/guides/v1.4.0/table-qa) guide.
...
See [Optimization](/guides/v1.4.0/optimization) for suggestions on how to choose top-k values.
...
BM25 is a variant of [TF-IDF](https://haystack.deepset.ai/pipeline_nodes/v1.4.0/retriever#tf-idf).
...
If you’d like to learn how to set up a DPR based system, have a look at the [tutorial](/tutorials/v1.4.0/dense-passage-retrieval)!
...
**Training DPR:** Haystack supports training of your own DPR model! Check out the [tutorial](/tutorials/v1.4.0/train-dpr) to see how this is done!
