...
To build modern search pipelines, you need two things: powerful [building blocks](/pipeline_nodes/v1.4.0/overview) and an easy way to stick them together.
...
Last but not least, we added some ready-made pipelines that allow you to run standard patterns with very few lines of code. See the [ready-made pipelines page](/components/v1.4.0/ready-made-pipelines) and [pipelines API documentation](/reference/v1.4.0/pipelines) to learn more about these.
