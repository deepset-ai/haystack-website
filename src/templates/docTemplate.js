              ...
              <div className="doc-post">
                ...
                <div>
                  {version==="latest" ? (
                    ...
                    href={`https://github.com/deepset-ai/haystack/tree/add_docs_060/docs/_src/${editPath}`}
                    target="_blank"
                  ...
                  <a
                  className="edit-page-link btn"
                  href={`https://github.com/deepset-ai/haystack/tree/add_docs_060/docs/${version}/_src/${editPath}`}
                  target="_blank"
                  rel="noreferrer noopener"
                >
                  <FontAwesomeIcon icon={faEdit}/>
