    ...
    <section className="product-features">
      ...
      <div className="core-features">
        <a href="/en/docs/tutorial1md">
            ...
            <p>Question answering can be used for navigating through complex knowledge bases.</p>
            </div>
        </a>
        <a href="/en/docs/tutorial2md">
          <div className="core-feature-3">
            ...
            <p>If you have domain-speficic questions, fine-tuning your model on custom examples will very likely boost your performance.</p>
          </div>
        </a>
        <a href="/en/docs/tutorial3md">
          <div className="core-feature-2">
            ...
            <h3>Confugire your Document Store</h3>
            <p>Haystack provides alternatives to Elasticsearch for developing quick prototypes</p>
          </div>
        </a>
      </div>
    </section>
