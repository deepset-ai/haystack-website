...
See [our tutorial](/tutorials/v0.10.0/train-dpr) and also the [API reference](/reference/v0.10.0/retriever#train) for `DensePassageRetriever.train()` for more details.
