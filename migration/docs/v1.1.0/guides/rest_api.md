...
The Haystack [Pipeline](/components/v1.1.0/pipelines) is at the core of Haystack’s QA functionality, whether Haystack is used directly through the Python bindings or through a REST API.
...
When running Haystack as a REST API, you'll need to define the pipeline you'll be using in the API as a YAML file. Check out the [Pipelines YAML doc](/components/v1.1.0/pipelines) for more details.
...
**Note:** If you'd like to learn how to pass parameters into your Pipeline, see the [Pipeline arguments section](/components/v1.1.0/pipelines#arguments).
