...
If you have your tables embedded in raw files (e.g. within a PDF), you can use the `AzureConverter` to parse them into the required format (see [File Converters](/pipeline_nodes/file-converters)).
...
**Note:** When the [Answers](/components/documents-answers-labels#answers) are returned by the `TableReader`,
