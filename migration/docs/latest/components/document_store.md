...
Note that the Retriever functions as a [Node](/pipeline_nodes/overview)
...
See [PreProcessor}](/pipeline_nodes/preprocessor) for more information on the cleaning and splitting steps that will help you maximize Haystack's performance.
