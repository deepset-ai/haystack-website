...
To learn more about how to use this component in Haystack, have a look at our [Table Question Answering](/guides/v1.2.0/table-qa) guide.
...
See [Optimization](/guides/v1.2.0/optimization) for suggestions on how to choose top-k values.

<div style={{ marginBottom: "3rem" }} />

## BM25 (Recommended)

BM25 is a variant of [TF-IDF](https://haystack.deepset.ai/components/v1.2.0/retriever#tf-idf) that we recommend you use if you are looking for a retrieval method that does not need a neural network for indexing.
...
If you’d like to learn how to set up a DPR based system, have a look at the [tutorial](/tutorials/v1.2.0/dense-passage-retrieval)!
...
**Training DPR:** Haystack supports training of your own DPR model! Check out the [tutorial](/tutorials/v1.2.0/train-dpr) to see how this is done!
