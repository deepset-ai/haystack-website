...
See [this page](https://www.elastic.co/guide/en/elasticsearch/reference/v1.2.0/current/analysis-lang-analyzer.html)
...
See [our tutorial](/tutorials/v1.2.0/train-dpr) and also the [API reference](/reference/v1.2.0/retriever#train) for `DensePassageRetriever.train()` for more details.
