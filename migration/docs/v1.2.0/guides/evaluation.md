...
To get started using Haystack for evaluation, we recommend having a look at our [evaluation tutorial](/tutorials/v1.2.0/evaluation)
...
You can already start trying out SAS in our [Evaluation Tutorial](/tutorials/v1.2.0/evaluation). You can read more about SAS in [this paper](https://arxiv.org/abs/2108.06130).
...
Please check out our [annotation tool](/guides/v1.2.0/annotation) if you're interested in creating your own dataset.
