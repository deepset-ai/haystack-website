...
please check out [Get Started](/overview/v1.2.0/get-started).
...
- **NLP for Search**: Pick components that perform [retrieval](/components/v1.2.0/retriever),
[question answering](/components/v1.2.0/reader), [reranking](/components/v1.2.0/ranker) and much more
...
- **Flexible databases**: Load data into and query from a range of [databases](/components/v1.2.0/document-store) such as Elasticsearch, Milvus, FAISS, SQL and more

- **Scalability**: [Scale your system](/guides/v1.2.0/optimization) to handle millions of documents and deploy them via [REST API](/guides/v1.2.0/rest-api)

- **Domain adaptation**: All tooling you need to [annotate](/guides/v1.2.0/annotation) examples, collect [user-feedback](/guides/v1.2.0/domain-adaptation#user-feedback), [evaluate](/guides/v1.2.0/evaluation) components and [finetune](/guides/v1.2.0/domain-adaptation) models.
...
- [Question Answering](/components/v1.2.0/ready-made-pipelines#extractiveqapipeline)
- [Summarization](/components/v1.2.0/ready-made-pipelines#searchsummarizationpipeline)
- [Document Search](/components/v1.2.0/ready-made-pipelines#documentsearchpipeline)
- [Question Generation](/components/v1.2.0/ready-made-pipelines#questiongenerationpipeline)
...
Haystack offers different [Nodes](/components/v1.2.0/nodes) that perform different kinds of text processing.
...
The [Pipeline](/components/v1.2.0/pipelines) is the key to making this modular approach work.
...
On top of simplifying data flow logic, this also allows for complex routing options such as those involving [decision nodes](/components/v1.2.0/nodes#decision-nodes).
...
For this, Haystack comes with a [REST API](/guides/v1.2.0/rest-api) that is designed to work in production environments.

When set up like this, you can load [Pipelines from YAML files](/components/v1.2.0/pipelines#yaml-file-definitions),
...
harnesses the reading comprehension power of the [Reader](/components/v1.2.0/reader)
but also applies it to large document bases with the help of the [Retriever](/components/v1.2.0/retriever).
...
** Question Answering Tutorial**: To start building your first question answering system, see our [Introductory Tutorial](/tutorials/v1.2.0/first-qa-system)
...
Many of the synergistic Node combinations are covered by our [Ready Made Pipelines](/components/v1.2.0/ready-made-pipelines)
