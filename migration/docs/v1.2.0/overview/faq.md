...
your documents into smaller chunks by using the `PreProcessor` (see [tutorial](https://haystack.deepset.ai/tutorials/v1.2.0/pipelines)).
...
(for an example of what a `filters` dictionary might look like, please refer to [this example](https://haystack.deepset.ai/reference/v1.2.0/retriever#__init__))

<div style={{ marginBottom: "3rem" }} />

## How can I see each component's output if it's running in a pipeline?

To find out more about how to debug a pipeline, have a look at our [Pipelines documentation page](/components/v1.2.0/pipelines#returning-debugging-information).
