...
Have a look at our guide on [Table Question Answering](/guides/v1.0.0/table-qa) to find out more.
...
**Tutorial:** If you'd like a hands on example, check out our tutorial on fine-tuning [here](/tutorials/v1.0.0/fine-tuning-a-model)
