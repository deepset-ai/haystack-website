...
To learn more about how to use this component in Haystack, have a look at our [Table Question Answering](/guides/v1.0.0/table-qa) guide.
...
See [Optimization](/guides/v1.0.0/optimization) for suggestions on how to choose top-k values.
...
If you’d like to learn how to set up a DPR based system, have a look at the [tutorial](/tutorials/v1.0.0/dense-passage-retrieval)!
...
**Training DPR:** Haystack supports training of your own DPR model! Check out the [tutorial](/tutorials/v1.0.0/train-dpr) to see how this is done!
